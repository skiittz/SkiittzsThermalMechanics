...
namespace SkiittzsThermalMechanics.Data.Scripts.SkiittzsThermalMechanics.Core
{
	public partial class ThrusterHeatData
	{
		...
		private float CalculateHeating(IMyThrust block)
		{
			if (block == null || !block.IsWorking)
				return 0;
			return (block.CurrentThrust * MwHeatPerNewtonThrust * Configuration.Configuration.GlobalHeatGenerationMultiplier) - PassiveCooling;
		}
	}
	public partial class PowerPlantHeatData
	{
		...
		private float CalculateHeating(IMyPowerProducer block)
		{
			...
			return (block.CurrentOutput * safeMultiplier * spamPenalty * Configuration.Configuration.GlobalHeatGenerationMultiplier) - PassiveCooling;
		}
